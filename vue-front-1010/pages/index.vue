                ...
                <li v-for="teacher in teacherList" :key="teacher.id">
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a :href="'/teacher/'" :title="teacher.name">
...
export default {
  ...
  methods: {
    ...
    getHotCourseTeacher() {
      index.getHotTeacherCourse().then((response) => {
        // console.log(response.data.data);
        this.courseList = response.data.data.topCourses;
        this.teacherList = response.data.data.topTeachers;
      });
    },
  },
};
